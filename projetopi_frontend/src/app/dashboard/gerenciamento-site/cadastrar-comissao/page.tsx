								...
								if (user.situation === 'accept' && accepted) {
									return (
										...
										>
											...
											<td>{user.email}</td>
											<td className="flex flex-row items-center justify-center px-4 py-8 text-center">
												<button className="flex items-center justify-center rounded-full border border-black bg-transparent px-2 py-[2px] pl-2 text-base font-medium text-black ">
													Ver Mais
